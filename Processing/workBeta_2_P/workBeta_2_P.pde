/*
  ...
  */
  ...
  /*create a rectangle,and its color and location are random.
    When I first time code the project, I want to use many commands like this to achieve the goals
    I hope things don`t come back when they are lost
    And then I find  a better way,So I left a line of command
    */
 ...
 /* Then I create a ellipse,it will leave a trail on the backgroud
    ...
    And when pressed mouse it will get a random color
    */
    strokeWeight(0);
    if(mousePressed)
 {
...
// Use that,I create a "star" and it is easy to copy andrevise
 ...
 fill(c1,c2,c3);
 ellipse(120+frameCount,150+frameCount,20,20); fill(c1,c2,c3);
 ellipse(70+frameCount,50+frameCount,20,20); fill(c1,c2,c3);
